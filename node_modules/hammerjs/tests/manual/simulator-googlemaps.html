...
<div class="container">
    ...
    <p style="font-size: 1.5rem;" >Used for unit-testing Hammer.js. To test it on the Google Maps view, you should open your
    ...
    <p style="font-size: 1.5rem;" >Currently, it only triggers touchEvents.</p>
</div>
