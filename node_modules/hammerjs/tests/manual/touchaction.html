...
<body>
    ...
    <div class="container">
        <p style="font-size: 1.5rem;" >Hammer provides a <a href="../../src/touchaction.js">kind of polyfill</a>
        ...
        <p style="font-size: 1.5rem;" >Should prevent nothing.</p>
        <div class="tester azure" id="auto"></div>

        <h2>touch-action: pan-y</h2>
        <p style="font-size: 1.5rem;" >Should prevent scrolling on horizontal movement. This is set by default when creating a Hammer instance.</p>
        <div class="tester azure" id="pan-y"></div>

        <h2>touch-action: pan-x</h2>
        <p style="font-size: 1.5rem;" >Should prevent scrolling on vertical movement.</p>
        <div class="tester azure" id="pan-x"></div>

        <h2>touch-action: pan-x pan-y</h2>
        <p style="font-size: 1.5rem;" >Should <strong>not</strong> prevent any scrolling on any movement. Horizontal and vertical scrolling handled by the browser directly.</p>
        <div class="tester azure" id="pan-x-pan-y"></div>

        <h2>touch-action: none</h2>
        <p style="font-size: 1.5rem;" >Should prevent all.</p>
