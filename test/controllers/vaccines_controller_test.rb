...
class VaccinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaccine" do
    assert_difference('Vaccine.count') do
      post vaccines_url, params: { vaccine: { client_id: @vaccine.client_id, desc: @vaccine.desc, expiration: @vaccine.expiration, lote: @vaccine.lote, name: @vaccine.name, provider: @vaccine.provider, quantity: @vaccine.quantity } }
    end
  ...
  test "should update vaccine" do
    patch vaccine_url(@vaccine), params: { vaccine: { client_id: @vaccine.client_id, desc: @vaccine.desc, expiration: @vaccine.expiration, lote: @vaccine.lote, name: @vaccine.name, provider: @vaccine.provider, quantity: @vaccine.quantity } }
